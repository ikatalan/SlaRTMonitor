...
{
    public partial class PredictionReport : Form
    {
        ...
        private SqlConnection dbConnection4;//Open connections for Prediction graph
        private SqlCommand predictionSqlCommand;//used for filling list of items (device_name) per threshold_id      
        ...
        public void Graphs_Load(object sender, EventArgs e)
        {
            ...
            // Used for filling list of items (device_name) per threshold_id            
            predictionSqlCommand = new SqlCommand(
            ...
            if (((predictionSqlCommand.Connection.State & global::System.Data.ConnectionState.Open)
                        != global::System.Data.ConnectionState.Open))
            {
                predictionSqlCommand.Connection.Open();
            }

            predictionSqlCommand.CommandType = global::System.Data.CommandType.Text;
            predictionSqlCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@device_name", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "device_name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            predictionSqlCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@threshold_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "threshold_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            cmbBoxThresholdTypes_SelectedIndexChanged(null, null);//Show the first gaugeValue
        }
        ...
        private PointPairList GetPredictionForDevice(string deviceName, int thresholdId)
        {
            ...
            try
            {
                ...
                predictionSqlCommand.Parameters[0].Value = deviceName;
                predictionSqlCommand.Parameters[1].Value = thresholdId;
                

                global::System.Data.ConnectionState previousConnectionState = predictionSqlCommand.Connection.State;
                if (((predictionSqlCommand.Connection.State & global::System.Data.ConnectionState.Open)
                            != global::System.Data.ConnectionState.Open))
                {
                    predictionSqlCommand.Connection.Open();
                ...
                measurementsReader = predictionSqlCommand.ExecuteReader();
