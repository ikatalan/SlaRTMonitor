...
{
    public partial class ReportsByTime : Form
    {
        ...
        public void ReportsByTime_Load(object sender, EventArgs e)
        {
            ...
            measurmentsValuesAdapter.SelectCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@start_time", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "start_time", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            measurmentsValuesAdapter.SelectCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@end_time", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "end_time", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            cmbBoxThresholdTypes_SelectedIndexChanged(this.cmbBoxThresholdTypes, null);//Show the first gaugeValue
        ...
        private void cmbBoxThresholdTypes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (sender == cmbBoxThresholdTypes)
            {
        ...
        private PointPairList GetValuesForDevice(String deviceName, int threshold_id)
        {
            ...
            try
            {
                ...
                measurmentsValuesAdapter.SelectCommand.Parameters[2].Value = dateTimePicker1.Value;
                measurmentsValuesAdapter.SelectCommand.Parameters[3].Value = dateTimePicker2.Value;
